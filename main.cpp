...
string names[MAX_SPECIALIZATION+1][MAX_QUEUE+1];  // Indexing starts from 0, so we need MAX_SPECIALIZATION and MAX_QUEUE
...
// Move each patient to the left. E.g if patient is in position 5, it will be in 4
// Helps in removing patient
...
// Move each patient to the right. E.g if patient is in position 5, it will be in 6
// Helps in adding patient
...
int main() {
    // freopen("c.in", "rt", stdin);  // This line is typically used for reading from a file in debugging or testing
    hospital_system();
    return 0;
}
